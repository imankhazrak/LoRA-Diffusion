...
\caption{Performance vs.\ training data size (SST-2 validation accuracy). Generated from real sweep results via \texttt{scripts/run\_data\_efficiency\_sweep.py}; LoRA-Diffusion and weight LoRA are trained at 10\%, 20\%, 40\%, 60\%, 80\%, and 100\% of the training set.}
