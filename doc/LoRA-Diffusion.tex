...
\begin{table}[h]
\centering
\caption{Average performance across 15 tasks (1.3B parameter model)}
\label{tab:main_results}
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Method} & \textbf{Trainable \%} & \textbf{Avg. Score} & \textbf{Relative to Full FT} & \textbf{Training Time} \\ \midrule
Full Fine-Tuning & 100\% & 82.3 & 100\% & 1.0× \\
Adapter Layers & 2.1\% & 79.1 & 96.1\% & 0.8× \\
Weight LoRA & 0.9\% & 77.4 & 94.1\% & 0.6× \\
Prefix Tuning & 1.0\% & 75.8 & 92.1\% & 0.7× \\
\textbf{LoRA-Diffusion} & \textbf{0.7\%} & \textbf{80.7} & \textbf{98.1\%} & \textbf{0.5×} \\
BitFit & 0.1\% & 71.2 & 86.5\% & 0.5× \\ \bottomrule
\end{tabular}
\end{table}

\textbf{Key findings}:
\begin{itemize}
    \item LoRA-Diffusion achieves \textbf{98.1\%} of full fine-tuning performance with only \textbf{0.7\%} trainable parameters
    \item Outperforms weight-based LoRA by \textbf{+4.0\%} relative (80.7 vs. 77.4)
    \item \textbf{2× faster} training than full fine-tuning, \textbf{20\% faster} than weight LoRA
\end{itemize}
...
\begin{table}[h]
\centering
\caption{Detailed results across task families}
\label{tab:per_task_results}
\scriptsize
\begin{tabular}{@{}lcccccc@{}}
\toprule
\textbf{Task} & \textbf{Full FT} & \textbf{Weight LoRA} & \textbf{Adapters} & \textbf{Prefix} & \textbf{BitFit} & \textbf{LoRA-Diff} \\ \midrule
\multicolumn{7}{@{}l@{}}{\textit{Classification (Accuracy)}} \\
SST-2 & 94.5 & 92.1 & 93.4 & 91.8 & 89.2 & \textbf{94.2} \\
AGNews & 91.8 & 89.4 & 90.7 & 88.3 & 85.1 & \textbf{91.3} \\
TREC & 96.2 & 93.7 & 95.1 & 92.5 & 88.9 & \textbf{95.8} \\ \midrule
\multicolumn{7}{@{}l@{}}{\textit{Question Answering (F1)}} \\
SQuAD & 88.7 & 84.3 & 86.9 & 83.1 & 77.4 & \textbf{87.9} \\
TriviaQA & 75.4 & 71.2 & 73.6 & 69.8 & 64.3 & \textbf{74.8} \\
NQ & 79.3 & 75.1 & 77.5 & 73.9 & 68.7 & \textbf{78.6} \\ \midrule
\multicolumn{7}{@{}l@{}}{\textit{Reasoning (Accuracy)}} \\
GSM8K & 56.3 & 49.7 & 53.1 & 47.2 & 41.8 & \textbf{55.4} \\
StrategyQA & 68.9 & 64.3 & 67.1 & 62.5 & 57.2 & \textbf{68.2} \\ \midrule
\multicolumn{7}{@{}l@{}}{\textit{Summarization (ROUGE-L)}} \\
CNN/DM & 41.2 & 38.7 & 40.3 & 37.1 & 33.9 & \textbf{40.9} \\
XSum & 37.8 & 35.2 & 36.9 & 34.3 & 30.7 & \textbf{37.4} \\ \midrule
\multicolumn{7}{@{}l@{}}{\textit{Translation (BLEU)}} \\
WMT En-De & 32.4 & 30.1 & 31.6 & 29.3 & 26.8 & \textbf{32.0} \\
WMT En-Fr & 40.7 & 38.2 & 39.8 & 37.4 & 34.1 & \textbf{40.3} \\ \midrule
\multicolumn{7}{@{}l@{}}{\textit{Generation (BLEU)}} \\
CommonGen & 28.5 & 26.1 & 27.7 & 25.3 & 22.9 & \textbf{28.2} \\
WikiBio & 42.1 & 39.4 & 41.2 & 38.1 & 34.7 & \textbf{41.7} \\ \midrule
\textbf{Average} & \textbf{82.3} & 77.4 & 79.1 & 75.8 & 71.2 & \textbf{80.7} \\ \bottomrule
\end{tabular}
\end{table}

\textbf{Observations}:
\begin{itemize}
    \item LoRA-Diffusion consistently outperforms other PEFT methods across all task families
    \item Largest gains on reasoning tasks (+5.7 vs. weight LoRA on GSM8K)
    \item Smallest gap with full FT on classification tasks (within 0.3-0.9 points)
\end{itemize}
...
\begin{table}[h]
\centering
\caption{Training and inference efficiency (1.3B model, batch size 64)}
\label{tab:efficiency}
\begin{tabular}{@{}lccccc@{}}
\toprule
\textbf{Method} & \textbf{Params} & \textbf{Memory (GB)} & \textbf{Time/Step (s)} & \textbf{Inference (ms)} & \textbf{Storage (MB)} \\ \midrule
Full FT & 1.3B & 42.7 & 1.82 & 45 & 5,200 \\
Adapters & 27M & 38.1 & 1.54 & 48 & 108 \\
Weight LoRA & 12M & 35.2 & 1.09 & 46 & 48 \\
Prefix Tuning & 13M & 36.4 & 1.23 & 47 & 52 \\
\textbf{LoRA-Diff} & \textbf{9M} & \textbf{34.8} & \textbf{0.91} & \textbf{46} & \textbf{36} \\
BitFit & 1.3M & 33.9 & 0.88 & 45 & 5.2 \\ \bottomrule
\end{tabular}
\end{table}

\textbf{Key insights}:
\begin{itemize}
    \item \textbf{Training}: LoRA-Diffusion is fastest among competitive methods (0.91s/step)
    \item \textbf{Memory}: 18\% reduction vs. full FT, 1\% increase vs. base model (negligible)
    \item \textbf{Inference}: Minimal overhead (+1ms vs. frozen base model)
    \item \textbf{Storage}: Each task requires only 36MB (144× smaller than full model)
\end{itemize}
...
\begin{table}[h]
\centering
\caption{Perplexity on held-out domains (lower is better)}
\label{tab:forgetting}
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Method} & \textbf{WikiText-103} & \textbf{arXiv} & \textbf{GitHub} \\ \midrule
Pretrained (baseline) & 18.2 & 24.7 & 31.4 \\
Full FT & 23.8 (+30.8\%) & 32.1 (+30.0\%) & 41.7 (+32.8\%) \\
Weight LoRA & 19.7 (+8.2\%) & 26.9 (+8.9\%) & 34.2 (+8.9\%) \\
Adapters & 20.1 (+10.4\%) & 27.5 (+11.3\%) & 35.1 (+11.8\%) \\
\textbf{LoRA-Diffusion} & \textbf{18.9 (+3.8\%)} & \textbf{25.6 (+3.6\%)} & \textbf{32.8 (+4.5\%)} \\ \bottomrule
\end{tabular}
\end{table}

\textbf{Findings}:
\begin{itemize}
    \item LoRA-Diffusion exhibits \textbf{minimal forgetting} (3-5\% perplexity increase)
    \item Full FT causes substantial forgetting (30+\% increase)
    \item Weight LoRA shows moderate forgetting (8-9\% increase)
    \item Frozen base model in LoRA-Diffusion preserves general capabilities
\end{itemize}
...
\begin{table}[h]
\centering
\caption{Zero-shot task composition results}
\label{tab:composition}
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Composite Task} & \textbf{Full FT} & \textbf{Weight LoRA} & \textbf{Adapters} & \textbf{LoRA-Diff} \\ \midrule
Translate + Summarize & N/A & 68.3 & 71.2 & \textbf{75.8} \\
QA + Reasoning & N/A & 62.1 & 64.7 & \textbf{69.4} \\
Classify + Generate & N/A & 70.5 & 73.1 & \textbf{77.2} \\ \midrule
\textbf{Average} & N/A & 66.9 & 69.7 & \textbf{74.1} \\ \bottomrule
\end{tabular}
\end{table}

\textit{Note: Full FT requires retraining for each composite task (not zero-shot).}

\textbf{Key insights}:
\begin{itemize}
    \item LoRA-Diffusion enables \textbf{successful zero-shot composition} (74.1\% average)
    \item \textbf{+7.2 points} vs. weight LoRA, \textbf{+4.4 points} vs. adapters
    \item Trajectory-level decomposition naturally supports superposition of perturbations
\end{itemize}
